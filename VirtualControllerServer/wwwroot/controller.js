...
class VirtualController {
    constructor() {
        ...
        // Stick tracking
        this.leftStick = { active: false, startX: 0, startY: 0, touchId: null };
        this.rightStick = { active: false, startX: 0, startY: 0, touchId: null };
    ...
    toggleEditMode() {
        ...
        if (navigator.vibrate) navigator.vibrate(this.isEditMode ? [30, 20, 30] : 30);
